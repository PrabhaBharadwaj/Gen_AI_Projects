...
# MAGIC %pip install --quiet --upgrade databricks-vectorsearch langchain
...
# DBTITLE 1,Connect to Vector Search
############
...
# MAGIC
# MAGIC ![Example Flow for RAG](https://docs.databricks.com/en/_images/rag-workflow.png)
