...
# Here it executes in sequence,
# user_proxy --> inquiry_agent, inquiry_agent-->user_proxy,  ==========>Trigger
# user_proxy-->response_agent, response_agent-->user_proxy,
# user_proxy -->knowledge_base_agent, knowledge_base_agent-->user_proxy
# user_proxy -->troubleshooting_agent, troubleshooting_agent-->user_proxy
# user_proxy -->feedback_agent, feedback_agent-->user_proxy
# user_proxy -->escalation_agent, escalation_agent-->user_proxy
...
user_proxy.register_nested_chats(
    [
        # Here we list all agents which needs to be considered inside nested chat
        {
            "recipient": response_agent,
            # Here last agents content are passed to response_agent
            "message": lambda recipient, messages, sender, config: f"Classify and respond to this inquiry: {messages[-1]['content']}",
            "summary_method": "last_msg",
            "max_turns": 1,
        },
        {
            # Here last agents content are passed to knowledge_base_agent
    ...
    trigger=inquiry_agent,  # This is the trigger agent
)
...
user_proxy.initiate_chat(
    recipient=inquiry_agent,  # Mention trigger agent
