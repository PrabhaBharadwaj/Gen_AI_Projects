...
user_proxy.register_nested_chats(
    [
        # 2nd it triggeres this 1st block, so executes read_csv_file() and passes "Generate a detailed financial report based on the following data:{Extraacteddata}" to report_generation_agent
        {
    ...
    trigger=data_aggregation_agent,  # This one triggered 1st
)
