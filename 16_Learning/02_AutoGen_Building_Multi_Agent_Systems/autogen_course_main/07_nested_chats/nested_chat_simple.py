...
# This help us to know wht internal going on. It reflects. it takes recepient content and pass it to critc and pass it to sender
...
# Here recipient.chat_messages_for_summary(sender)[-1]['content']: here recipient is writer agent's response
...
user_proxy.register_nested_chats(
    ...
    trigger=writer,  # user_proxy will trigger writer agent
)

# Define the task
task = """Write a 20 word and engaging product review for the new Meta VR headset."""
